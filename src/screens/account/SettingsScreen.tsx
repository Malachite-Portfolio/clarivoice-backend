  ...
  useFocusEffect(
    useCallback(() => {
      ...
      refreshPermissionStatuses()
        ...
        .catch((error) => {
          console.error("[permissions] settings refresh failed", error);
        });
    }, [userId])
  );
  ...
  async function handleMicrophonePermission() {
    ...
    if (nextStatus === "blocked") {
      Alert.alert(
        ...
        "Open app settings to allow voice calls to use your microphone.",
        [
          { text: "Later", style: "cancel" },
          { text: "Open settings", onPress: () => openAppSettings() },
        ]
        ...
        <View style={styles.content}>
          <SectionCard>
            ...
            <View style={styles.permissionStack}>
              <PermissionStatusCard
                ...
                description="Needed for chat replies, missed calls, and incoming call alerts on Android."
              ...
              <PermissionStatusCard
                ...
                description="Needed before joining an audio call so the other person can hear you."
          ...
          <SectionCard>
            ...
            <Text style={styles.caption}>
              Dark mode design variant is kept as a placeholder for future design/brand rollout.
            </Text>
          </SectionCard>
          ...
          >
            <Text style={styles.helpTitle}>Safety quick action</Text>
            <Text style={styles.helpText}>Emergency resources and crisis support hook.</Text>
          </Pressable>
